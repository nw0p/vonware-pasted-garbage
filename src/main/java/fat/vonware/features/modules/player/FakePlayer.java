...
import fat.vonware.util.DamageUtil;
import fat.vonware.util.PositionforFPUtil;
...
public class FakePlayer extends Module {
    ...
    private final fat.vonware.util.Timer timer = new Timer();
    ...
    public Setting<String> nameFakePlayer = this.register(new Setting<String>("Name FakePlayer", "Vonware"));
    ...
    void spawnPlayer() {
        // Clone empty player
        clonedPlayer = new EntityOtherPlayerMP(mc.world, new GameProfile(UUID.fromString("2e8e3789-db19-43cb-b819-89a91d696ae9"), nameFakePlayer.getValue() + incr));
        // Copy angles
