...
import fat.vonware.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = Vonware.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof VonwareGui) {
            VonwareGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
