...
public class Step extends Module
{
    ...
    public Step() {
        ...
        this.setInstance();
        this.height = (Setting<Integer>)this.register(new Setting("Height", 1, 1, 2));
        this.reverse = (Setting<Boolean>)this.register(new Setting("Reverse", false));
        this.timer = (Setting<Boolean>)this.register(new Setting("Timer", false));
        this.ticks = 0;
    }
